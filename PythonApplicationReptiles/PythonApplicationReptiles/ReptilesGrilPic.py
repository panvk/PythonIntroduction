import os                   #operation system（操作系统）的缩写，这个库是对操作系统的封装，os.path对文件路径（文件夹）的操作：增加、删除、修改、删除
import requests             #requests（要求）爬虫库 ，相关pip
from lxml import etree      # lxml是python的一个解析库，支持HTML和XML的解析，支持XPath解析方式，而且解析效率非常高，安装方式pip3 install lxml
